...
int main()
{
    printf("The input is recieved from \"input.txt\", and the results are created in \"index.html\". The input and output needs to be in the same folder as this C file\n");
